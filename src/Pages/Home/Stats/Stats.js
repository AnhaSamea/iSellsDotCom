...
const Stats = () => {
    return (
        <section className="p-6 my-6 bg-slate-100 text-slate-800 rounded-lg">
            <p className='text-xl font-bold text-slate-800 pb-5'>Statistics</p>
	<div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
		<div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-slate-300 text-slate-700">
			<div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-slate-700">
