...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<Link rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="self-center text-2xl font-semibold">iSells.com</span>
			</Link>
		</div>
	...
	<div className="py-6 text-sm text-center dark:text-gray-400">© 2022 iSells.com All rights reserved.</div>
</footer>
    );
};
